 ...
 */
class getMileStoneRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MileStoneRepository' shared autowired service.
     *
     * @return \App\Repository\MileStoneRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MileStoneRepository.php';

        return $container->privates['App\\Repository\\MileStoneRepository'] = new \App\Repository\MileStoneRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
